...
public sealed class SConnection
{
    ...
    public SConnection(TcpClient client)
    {
        ...
        DisconnectTime = SEngine.CurrentTime.AddMinutes(Config.DisconnectTime);
    ...
    public void Process(雕爷刻印激活 P)
    {
        ...
        {
            Player.ConsumeItem(Config.雕爷激活灵符需求, 物品);
            if (P.位置 == 12)
            {
                P.位置 = 2;
            }
    ...
    public void Process(装备铭文刻印 P)
    {
        ...
        {
            Player.ConsumeItem(Config.雕爷1号位铭文石, 物品2);
            Player.ConsumeItem(Config.雕爷1号位灵符, 物品);
            v.第一铭文 = InscriptionSkill.DataSheet[(ushort)P.铭文索引];
            Player.玩家装卸铭文(v.第一铭文.SkillID, 0);
            Player.玩家装卸铭文(v.第一铭文.SkillID, v.第一铭文.ID);
