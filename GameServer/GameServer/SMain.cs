...
public partial class SMain : Form
{
    ...
    public SMain()
    {
        ...
        S_BOSS一时间.Value = Config.BOSS一时间;
        S_BOSS一分钟.Value = Config.BOSS一分钟;
        S_BOSS一地图编号.Value = Config.BOSS一地图编号;
        S_BOSS一坐标X.Value = Config.BOSS一坐标X;
        S_BOSS一坐标Y.Value = Config.BOSS一坐标Y;
        ...
        S_BOSS二时间.Value = Config.BOSS二时间;
        S_BOSS二分钟.Value = Config.BOSS二分钟;
        S_BOSS二地图编号.Value = Config.BOSS二地图编号;
        S_BOSS二坐标X.Value = Config.BOSS二坐标X;
        S_BOSS二坐标Y.Value = Config.BOSS二坐标Y;
        S_BOSS三时间.Value = Config.BOSS三时间;
        S_BOSS三分钟.Value = Config.BOSS三分钟;
        S_BOSS三地图编号.Value = Config.BOSS三地图编号;
        S_BOSS三坐标X.Value = Config.BOSS三坐标X;
        S_BOSS三坐标Y.Value = Config.BOSS三坐标Y;
        S_BOSS四时间.Value = Config.BOSS四时间;
        S_BOSS四分钟.Value = Config.BOSS四分钟;
        S_BOSS四地图编号.Value = Config.BOSS四地图编号;
        S_BOSS四坐标X.Value = Config.BOSS四坐标X;
        S_BOSS四坐标Y.Value = Config.BOSS四坐标Y;
        S_BOSS五时间.Value = Config.BOSS五时间;
        S_BOSS五分钟.Value = Config.BOSS五分钟;
        S_BOSS五地图编号.Value = Config.BOSS五地图编号;
        S_BOSS五坐标X.Value = Config.BOSS五坐标X;
        S_BOSS五坐标Y.Value = Config.BOSS五坐标Y;
        S_BOSS名字二.Text = Config.BOSS名字二;
        S_BOSS二地图名字.Text = Config.BOSS二地图名字;
        S_BOSS名字三.Text = Config.BOSS名字三;
        S_BOSS三地图名字.Text = Config.BOSS三地图名字;
        S_BOSS名字四.Text = Config.BOSS名字四;
        S_BOSS四地图名字.Text = Config.BOSS四地图名字;
        S_BOSS名字五.Text = Config.BOSS名字五;
        S_BOSS五地图名字.Text = Config.BOSS五地图名字;
        ...
        S_自动BOSS1界面1开关.Value = Config.自动BOSS1界面1开关;
        S_自动BOSS1界面2开关.Value = Config.自动BOSS1界面2开关;
        S_自动BOSS1界面3开关.Value = Config.自动BOSS1界面3开关;
        S_自动BOSS1界面4开关.Value = Config.自动BOSS1界面4开关;
        S_自动BOSS1界面5开关.Value = Config.自动BOSS1界面5开关;
        ...
        拾取地图控制1.Value = Config.拾取地图控制1;
        拾取地图控制2.Value = Config.拾取地图控制2;
        拾取地图控制3.Value = Config.拾取地图控制3;
        拾取地图控制4.Value = Config.拾取地图控制4;
        拾取地图控制5.Value = Config.拾取地图控制5;
        拾取地图控制6.Value = Config.拾取地图控制6;
        拾取地图控制7.Value = Config.拾取地图控制7;
        拾取地图控制8.Value = Config.拾取地图控制8;
        ...
        S_世界BOSS名字.Text = Config.世界BOSS名字;
        S_BOSS名字一.Text = Config.BOSS名字一;
        S_BOSS一地图名字.Text = Config.BOSS一地图名字;
        S_世界BOSS时间.Value = Config.世界BOSS时间;
        S_世界BOSS分钟.Value = Config.世界BOSS分钟;
    ...
    private void UpdateNumericSettingsValue_ValueChanged(object sender, EventArgs e)
    {
        ...
        switch (control.Name)
        {
            ...
            case nameof(S_BOSS一时间): Config.BOSS一时间 = (byte)control.Value; break;
            case nameof(S_BOSS一分钟): Config.BOSS一分钟 = (byte)control.Value; break;
            case nameof(S_BOSS一地图编号): Config.BOSS一地图编号 = (int)control.Value; break;
            case nameof(S_BOSS一坐标X): Config.BOSS一坐标X = (int)control.Value; break;
            case nameof(S_BOSS一坐标Y): Config.BOSS一坐标Y = (int)control.Value; break;
            ...
            case nameof(S_BOSS二时间): Config.BOSS二时间 = (byte)control.Value; break;
            case nameof(S_BOSS二分钟): Config.BOSS二分钟 = (byte)control.Value; break;
            case nameof(S_BOSS二地图编号): Config.BOSS二地图编号 = (int)control.Value; break;
            case nameof(S_BOSS二坐标X): Config.BOSS二坐标X = (int)control.Value; break;
            case nameof(S_BOSS二坐标Y): Config.BOSS二坐标Y = (int)control.Value; break;
            case nameof(S_BOSS三时间): Config.BOSS三时间 = (byte)control.Value; break;
            case nameof(S_BOSS三分钟): Config.BOSS三分钟 = (byte)control.Value; break;
            case nameof(S_BOSS三地图编号): Config.BOSS三地图编号 = (int)control.Value; break;
            case nameof(S_BOSS三坐标X): Config.BOSS三坐标X = (int)control.Value; break;
            case nameof(S_BOSS三坐标Y): Config.BOSS三坐标Y = (int)control.Value; break;
            case nameof(S_BOSS四时间): Config.BOSS四时间 = (byte)control.Value; break;
            case nameof(S_BOSS四分钟): Config.BOSS四分钟 = (byte)control.Value; break;
            case nameof(S_BOSS四地图编号): Config.BOSS四地图编号 = (int)control.Value; break;
            case nameof(S_BOSS四坐标X): Config.BOSS四坐标X = (int)control.Value; break;
            case nameof(S_BOSS四坐标Y): Config.BOSS四坐标Y = (int)control.Value; break;
            case nameof(S_BOSS五时间): Config.BOSS五时间 = (byte)control.Value; break;
            case nameof(S_BOSS五分钟): Config.BOSS五分钟 = (byte)control.Value; break;
            case nameof(S_BOSS五地图编号): Config.BOSS五地图编号 = (int)control.Value; break;
            case nameof(S_BOSS五坐标X): Config.BOSS五坐标X = (int)control.Value; break;
            case nameof(S_BOSS五坐标Y): Config.BOSS五坐标Y = (int)control.Value; break;
            ...
            case nameof(S_世界BOSS时间): Config.世界BOSS时间 = (byte)control.Value; break;
            case nameof(S_世界BOSS分钟): Config.世界BOSS分钟 = (byte)control.Value; break;
            ...
            case nameof(S_自动BOSS1界面1开关): Config.自动BOSS1界面1开关 = (int)control.Value; break;
            case nameof(S_自动BOSS1界面2开关): Config.自动BOSS1界面2开关 = (int)control.Value; break;
            case nameof(S_自动BOSS1界面3开关): Config.自动BOSS1界面3开关 = (int)control.Value; break;
            case nameof(S_自动BOSS1界面4开关): Config.自动BOSS1界面4开关 = (int)control.Value; break;
            case nameof(S_自动BOSS1界面5开关): Config.自动BOSS1界面5开关 = (int)control.Value; break;
            ...
            case nameof(拾取地图控制1): Config.拾取地图控制1 = (int)control.Value; break;
            case nameof(拾取地图控制2): Config.拾取地图控制2 = (int)control.Value; break;
            case nameof(拾取地图控制3): Config.拾取地图控制3 = (int)control.Value; break;
            case nameof(拾取地图控制4): Config.拾取地图控制4 = (int)control.Value; break;
            case nameof(拾取地图控制5): Config.拾取地图控制5 = (int)control.Value; break;
            case nameof(拾取地图控制6): Config.拾取地图控制6 = (int)control.Value; break;
            case nameof(拾取地图控制7): Config.拾取地图控制7 = (int)control.Value; break;
            case nameof(拾取地图控制8): Config.拾取地图控制8 = (int)control.Value; break;
    ...
    private void UpdateBooleanSettingsValue_CheckedChanged(object sender, EventArgs e)
    {
        ...
        switch (control.Name)
        {
            ...
            case nameof(全屏拾取开关): Config.全屏拾取开关 = control.Checked; break;
    ...
    private void UpdateTextSettingsValue_TextChanged(object sender, EventArgs e)
    {
        ...
        switch (control.Name)
        {
            ...
            case nameof(S_世界BOSS名字): Config.世界BOSS名字 = control.Text; break;
            case nameof(S_BOSS名字一): Config.BOSS名字一 = control.Text; break;
            case nameof(S_BOSS一地图名字): Config.BOSS一地图名字 = control.Text; break;
            case nameof(S_BOSS二地图名字): Config.BOSS二地图名字 = control.Text; break;
            case nameof(S_BOSS三地图名字): Config.BOSS三地图名字 = control.Text; break;
            case nameof(S_BOSS四地图名字): Config.BOSS四地图名字 = control.Text; break;
            case nameof(S_BOSS五地图名字): Config.BOSS五地图名字 = control.Text; break;
            case nameof(S_BOSS名字二): Config.BOSS名字二 = control.Text; break;
            case nameof(S_BOSS名字三): Config.BOSS名字三 = control.Text; break;
            case nameof(S_BOSS名字四): Config.BOSS名字四 = control.Text; break;
            case nameof(S_BOSS名字五): Config.BOSS名字五 = control.Text; break;
