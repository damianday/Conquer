...
namespace ClientPacketSnifferApp
{
    public partial class FMain : Form
    {
        ...
        private void SaveCapture()
        {
            try
            {
                ...
                if (saveDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    //File.WriteAllLines(saveDialog.FileName, _lines);
        ...
        private void WriteData(DateTime now, bool packetFromClient, byte[] payloadData)
        {
            ...
            var str = "[" + now.ToString() + " " + packetFromClient.ToString() + "] " + payloadData.Length.ToString() + ": " + BitConverter.ToString(payloadData);
            _lines.Add(str);
        ...
        private void ButtonOpenRaw_Click(object sender, EventArgs e)
        {
            ...
            var form = new FRawFile();
            form.Text = Path.GetFileName(dialog.FileName);
